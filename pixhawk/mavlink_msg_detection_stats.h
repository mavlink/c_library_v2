						       ...
						       uint16_t detections, float best_score, int32_t best_lat, int32_t best_lon, int16_t best_alt, int32_t best_detection_id, uint16_t images_done, uint16_t images_todo, float fps)
{
	...
	_mav_put_float(buf, 0, best_score);
 ...
 */
static inline uint16_t mavlink_msg_detection_stats_get_detections(const mavlink_message_t* msg)
{
 ...
 *
 * @return ID of best detection
 */
static inline int32_t mavlink_msg_detection_stats_get_best_detection_id(const mavlink_message_t* msg)
{
