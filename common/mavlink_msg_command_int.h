...
#define MAVLINK_MSG_ID_COMMAND_INT_CRC 15
#define MAVLINK_MSG_ID_75_CRC 15
...
#define MAVLINK_MESSAGE_INFO_COMMAND_INT { \
	"COMMAND_INT", \
	13, \
	{  { "param1", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_command_int_t, param1) }, \
         { "param2", NULL, MAVLINK_TYPE_INT32_T, 0, 4, offsetof(mavlink_command_int_t, param2) }, \
         { "param3", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_command_int_t, param3) }, \
         { "param4", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_command_int_t, param4) }, \
         ...
         { "z", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_command_int_t, z) }, \
...
static inline uint16_t mavlink_msg_command_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t target_system, uint8_t target_component, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, int32_t param1, int32_t param2, int32_t param3, int32_t param4, int32_t x, int32_t y, int32_t z)
{
...
static inline void mavlink_msg_command_int_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, int32_t param1, int32_t param2, int32_t param3, int32_t param4, int32_t x, int32_t y, int32_t z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_COMMAND_INT_LEN];
	_mav_put_int32_t(buf, 0, param1);
 ...
 */
static inline int32_t mavlink_msg_command_int_get_param1(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_command_int_get_param2(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_command_int_get_param3(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_command_int_get_param4(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_command_int_get_z(const mavlink_message_t* msg)
{
