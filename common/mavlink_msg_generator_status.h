                               ...
                               uint64_t status, uint16_t generator_speed, float battery_current, float load_current, float power_generated, float bus_voltage, int16_t rectifier_temperature, float bat_current_setpoint, int16_t generator_temperature)
{
    ...
    _mav_put_uint16_t(buf, 28, generator_speed);
    _mav_put_int16_t(buf, 30, rectifier_temperature);
    _mav_put_int16_t(buf, 32, generator_temperature);
...
static inline void mavlink_msg_generator_status_send(mavlink_channel_t chan, uint64_t status, uint16_t generator_speed, float battery_current, float load_current, float power_generated, float bus_voltage, int16_t rectifier_temperature, float bat_current_setpoint, int16_t generator_temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GENERATOR_STATUS_LEN];
    _mav_put_uint64_t(buf, 0, status);
