...
#define MAVLINK_MSG_ID_ODOMETRY_LEN 222
#define MAVLINK_MSG_ID_ODOMETRY_MIN_LEN 222
#define MAVLINK_MSG_ID_331_LEN 222
#define MAVLINK_MSG_ID_331_MIN_LEN 222

#define MAVLINK_MSG_ID_ODOMETRY_CRC 123
#define MAVLINK_MSG_ID_331_CRC 123
...
#define MAVLINK_MESSAGE_INFO_ODOMETRY { \
    ...
    "ODOMETRY", \
    14, \
    {  { "frame_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 220, offsetof(mavlink_odometry_t, frame_id) }, \
         { "child_frame_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 221, offsetof(mavlink_odometry_t, child_frame_id) }, \
         { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_odometry_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_odometry_t, y) }, \
         { "z", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_odometry_t, z) }, \
         { "q", NULL, MAVLINK_TYPE_FLOAT, 4, 12, offsetof(mavlink_odometry_t, q) }, \
         { "vx", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_odometry_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_odometry_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_odometry_t, vz) }, \
         { "rollspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 40, offsetof(mavlink_odometry_t, rollspeed) }, \
         { "pitchspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 44, offsetof(mavlink_odometry_t, pitchspeed) }, \
         { "yawspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 48, offsetof(mavlink_odometry_t, yawspeed) }, \
         { "pose_covariance", NULL, MAVLINK_TYPE_FLOAT, 21, 52, offsetof(mavlink_odometry_t, pose_covariance) }, \
         { "twist_covariance", NULL, MAVLINK_TYPE_FLOAT, 21, 136, offsetof(mavlink_odometry_t, twist_covariance) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ODOMETRY { \
...
static inline uint16_t mavlink_msg_odometry_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t frame_id, uint8_t child_frame_id, float x, float y, float z, const float *q, float vx, float vy, float vz, float rollspeed, float pitchspeed, float yawspeed, const float *pose_covariance, const float *twist_covariance)
{
    ...
    _mav_put_float(buf, 40, rollspeed);
    _mav_put_float(buf, 44, pitchspeed);
    _mav_put_float(buf, 48, yawspeed);
    _mav_put_uint8_t(buf, 220, frame_id);
    _mav_put_uint8_t(buf, 221, child_frame_id);
    _mav_put_float_array(buf, 12, q, 4);
    _mav_put_float_array(buf, 52, pose_covariance, 21);
    _mav_put_float_array(buf, 136, twist_covariance, 21);
...
{
    return mavlink_msg_odometry_pack(system_id, component_id, msg, odometry->frame_id, odometry->child_frame_id, odometry->x, odometry->y, odometry->z, odometry->q, odometry->vx, odometry->vy, odometry->vz, odometry->rollspeed, odometry->pitchspeed, odometry->yawspeed, odometry->pose_covariance, odometry->twist_covariance);
}
...
{
    return mavlink_msg_odometry_pack_chan(system_id, component_id, chan, msg, odometry->frame_id, odometry->child_frame_id, odometry->x, odometry->y, odometry->z, odometry->q, odometry->vx, odometry->vy, odometry->vz, odometry->rollspeed, odometry->pitchspeed, odometry->yawspeed, odometry->pose_covariance, odometry->twist_covariance);
}
...
static inline void mavlink_msg_odometry_send(mavlink_channel_t chan, uint8_t frame_id, uint8_t child_frame_id, float x, float y, float z, const float *q, float vx, float vy, float vz, float rollspeed, float pitchspeed, float yawspeed, const float *pose_covariance, const float *twist_covariance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ODOMETRY_LEN];
    _mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_odometry_send(chan, odometry->frame_id, odometry->child_frame_id, odometry->x, odometry->y, odometry->z, odometry->q, odometry->vx, odometry->vy, odometry->vz, odometry->rollspeed, odometry->pitchspeed, odometry->yawspeed, odometry->pose_covariance, odometry->twist_covariance);
#else
...
{
    return _MAV_RETURN_float_array(msg, pose_covariance, 21,  52);
}
...
{
    return _MAV_RETURN_float_array(msg, twist_covariance, 21,  136);
}
