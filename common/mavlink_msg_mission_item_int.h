...
{
 int32_t param1; ///< PARAM1, see MAV_CMD enum
 int32_t param2; ///< PARAM2, see MAV_CMD enum
 int32_t param3; ///< PARAM3, see MAV_CMD enum
 int32_t param4; ///< PARAM4, see MAV_CMD enum
 int32_t x; ///< PARAM5 / local: x position, global: latitude in degrees * 10^7
 int32_t y; ///< PARAM6 / y position: global: longitude in degrees *10^7
 int32_t z; ///< PARAM7 / z position: global: altitude in millimeters (meters * 10^3) (relative or absolute, depending on frame.
...
#define MAVLINK_MSG_ID_MISSION_ITEM_INT_CRC 175
#define MAVLINK_MSG_ID_73_CRC 175
...
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_INT { \
	"MISSION_ITEM_INT", \
	14, \
	{  { "param1", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_mission_item_int_t, param1) }, \
         { "param2", NULL, MAVLINK_TYPE_INT32_T, 0, 4, offsetof(mavlink_mission_item_int_t, param2) }, \
         { "param3", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_mission_item_int_t, param3) }, \
         { "param4", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_mission_item_int_t, param4) }, \
         ...
         { "z", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_mission_item_int_t, z) }, \
 ...
 * @param x PARAM5 / local: x position, global: latitude in degrees * 10^7
 * @param y PARAM6 / y position: global: longitude in degrees *10^7
 * @param z PARAM7 / z position: global: altitude in millimeters (meters * 10^3) (relative or absolute, depending on frame.
...
static inline uint16_t mavlink_msg_mission_item_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, int32_t param1, int32_t param2, int32_t param3, int32_t param4, int32_t x, int32_t y, int32_t z)
{
...
static inline void mavlink_msg_mission_item_int_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, int32_t param1, int32_t param2, int32_t param3, int32_t param4, int32_t x, int32_t y, int32_t z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MISSION_ITEM_INT_LEN];
	_mav_put_int32_t(buf, 0, param1);
 ...
 */
static inline int32_t mavlink_msg_mission_item_int_get_param1(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_mission_item_int_get_param2(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_mission_item_int_get_param3(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_mission_item_int_get_param4(const mavlink_message_t* msg)
{
 ...
 *
 * @return PARAM5 / local: x position, global: latitude in degrees * 10^7
 */
 ...
 *
 * @return PARAM6 / y position: global: longitude in degrees *10^7
 */
 ...
 *
 * @return PARAM7 / z position: global: altitude in millimeters (meters * 10^3) (relative or absolute, depending on frame.
 */
static inline int32_t mavlink_msg_mission_item_int_get_z(const mavlink_message_t* msg)
{
