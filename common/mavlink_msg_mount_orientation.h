...
typedef struct __mavlink_mount_orientation_t {
 ...
 float yaw_absolute; /*< Yaw in absolute frame, North is 0 (set to NaN for invalid).*/
 ...
 * @param yaw_absolute Yaw in absolute frame, North is 0 (set to NaN for invalid).
 ...
 *
 * @return Roll in global frame (set to NaN for invalid).
 */
 ...
 *
 * @return Pitch in global frame (set to NaN for invalid).
 */
 ...
 *
 * @return Yaw relative to vehicle(set to NaN for invalid).
 */
 ...
 *
 * @return Yaw in absolute frame, North is 0 (set to NaN for invalid).
 */
