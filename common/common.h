...
#define MAVLINK_COMMON_XML_HASH 8097242645629414974
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_SEARCH=255, /* Start search |Spiral resolution| Spiral Resolution| Distance Between Spirals| Empty| Latitude| Longitude| Altitude|  */
