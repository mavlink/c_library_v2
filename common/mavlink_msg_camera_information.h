...
typedef struct __mavlink_camera_information_t {
 ...
 uint8_t camera_count; /*< Number of cameras (EXPERIMENTAL: IT WILL BE REMOVED)*/
 ...
 uint8_t cam_definition_uri[140]; /*< Camera definition URI (if any, otherwise only basic functions will be available).*/
}) mavlink_camera_information_t;

#define MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN 237
#define MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN 237
#define MAVLINK_MSG_ID_259_LEN 237
#define MAVLINK_MSG_ID_259_MIN_LEN 237

#define MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC 195
#define MAVLINK_MSG_ID_259_CRC 195
...
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_camera_information_t, time_boot_ms) }, \
         ...
         { "camera_count", NULL, MAVLINK_TYPE_UINT8_T, 0, 31, offsetof(mavlink_camera_information_t, camera_count) }, \
         { "vendor_name", NULL, MAVLINK_TYPE_UINT8_T, 32, 32, offsetof(mavlink_camera_information_t, vendor_name) }, \
         { "model_name", NULL, MAVLINK_TYPE_UINT8_T, 32, 64, offsetof(mavlink_camera_information_t, model_name) }, \
         { "lens_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 96, offsetof(mavlink_camera_information_t, lens_id) }, \
         { "cam_definition_uri", NULL, MAVLINK_TYPE_UINT8_T, 140, 97, offsetof(mavlink_camera_information_t, cam_definition_uri) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION { \
 ...
 * @param camera_count Number of cameras (EXPERIMENTAL: IT WILL BE REMOVED)
...
static inline uint16_t mavlink_msg_camera_information_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, uint8_t camera_id, uint8_t camera_count, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, float focal_length, float sensor_size_h, float sensor_size_v, uint16_t resolution_h, uint16_t resolution_v, uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version, const uint8_t *cam_definition_uri)
{
    ...
    _mav_put_uint8_t(buf, 31, camera_count);
    _mav_put_uint8_t(buf, 96, lens_id);
    _mav_put_uint8_t_array(buf, 32, vendor_name, 32);
    _mav_put_uint8_t_array(buf, 64, model_name, 32);
    _mav_put_uint8_t_array(buf, 97, cam_definition_uri, 140);
    ...
    mav_array_memcpy(packet.cam_definition_uri, cam_definition_uri, sizeof(uint8_t)*140);
 ...
 *
 * @return Number of cameras (EXPERIMENTAL: IT WILL BE REMOVED)
 */
...
{
    return _MAV_RETURN_uint8_t_array(msg, vendor_name, 32,  32);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, model_name, 32,  64);
}
 ...
 */
static inline uint16_t mavlink_msg_camera_information_get_cam_definition_uri(const mavlink_message_t* msg, uint8_t *cam_definition_uri)
{
    return _MAV_RETURN_uint8_t_array(msg, cam_definition_uri, 140,  97);
}
