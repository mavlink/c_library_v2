...
#define MAVLINK_MSG_ID_REQUEST_CONTROL_ACK_LEN 1
#define MAVLINK_MSG_ID_REQUEST_CONTROL_ACK_MIN_LEN 1
#define MAVLINK_MSG_ID_443_LEN 1
#define MAVLINK_MSG_ID_443_MIN_LEN 1

#define MAVLINK_MSG_ID_REQUEST_CONTROL_ACK_CRC 236
#define MAVLINK_MSG_ID_443_CRC 236
...
#define MAVLINK_MESSAGE_INFO_REQUEST_CONTROL_ACK { \
    ...
    "REQUEST_CONTROL_ACK", \
    1, \
    {  { "error_code", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_request_control_ack_t, error_code) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_REQUEST_CONTROL_ACK { \
                               ...
                               uint8_t error_code)
{
    ...
    _mav_put_uint8_t(buf, 0, error_code);
...
{
    return mavlink_msg_request_control_ack_pack(system_id, component_id, msg, request_control_ack->error_code);
}
...
{
    return mavlink_msg_request_control_ack_pack_chan(system_id, component_id, chan, msg, request_control_ack->error_code);
}
...
static inline void mavlink_msg_request_control_ack_send(mavlink_channel_t chan, uint8_t error_code)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_REQUEST_CONTROL_ACK_LEN];
    _mav_put_uint8_t(buf, 0, error_code);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_request_control_ack_send(chan, request_control_ack->error_code);
#else
 ...
 */
static inline void mavlink_msg_request_control_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t error_code)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
